    ...
    methods: {
        ...
        check_username: function () {
            ...
            if (this.error_name === false) {
                const url = this.host + '/usernames/' + this.username + '/count/';
                axios.get(url, {
                    responseType: 'json',
        ...
        check_phone: function () {
            ...
            if (this.error_phone === false) {
                const url = this.host + '/mobiles/' + this.mobile + '/count/';
                axios.get(url, {
                    responseType: 'json',
                    withCredentials: true,
                })
        ...
        send_sms_code: function () {
            ...
            const url = this.host + '/sms_codes/' + this.mobile + '/' + '?image_code=' + this.image_code
